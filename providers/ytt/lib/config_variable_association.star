...
"ENABLE_OIDC": ["vsphere", "aws", "azure", "docker", "oci"],
"OIDC_ISSUER_URL": ["vsphere", "aws", "azure", "docker", "oci"],
"OIDC_USERNAME_CLAIM": ["vsphere", "aws", "azure", "docker", "oci"],
"OIDC_GROUPS_CLAIM": ["vsphere", "aws", "azure", "docker", "oci"],
"OIDC_DEX_CA": ["vsphere", "aws", "azure", "docker", "oci"],
